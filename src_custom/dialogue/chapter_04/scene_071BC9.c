...
/* Script id 374 — map/NPC talk via event records (@ 0x080179C8 → StartTalkById). No cutscene FSM. Talk ROM 0x08071BC9. */
EVENT_SCRIPT_REPLACEMENT(0x08071BC9, scene_071BC9)
