...
/* Script id 351 — map/NPC talk via event records (@ 0x080179C8 → StartTalkById). No cutscene FSM. Talk ROM 0x0806F3F4. */
EVENT_SCRIPT_REPLACEMENT(0x0806F3F4, scene_06F3F4)
