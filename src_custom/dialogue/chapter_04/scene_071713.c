...
/* Script id 370 — map/NPC talk via event records (@ 0x080179C8 → StartTalkById). No cutscene FSM. Talk ROM 0x08071713. */
EVENT_SCRIPT_REPLACEMENT(0x08071713, scene_071713)
