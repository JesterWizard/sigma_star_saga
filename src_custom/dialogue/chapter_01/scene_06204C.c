...
/* Script id 133 — map/NPC talk via event records (@ 0x080179C8 → StartTalkById). No cutscene FSM. Talk ROM 0x0806204C. */
EVENT_SCRIPT_REPLACEMENT(0x0806204C, scene_06204C)
