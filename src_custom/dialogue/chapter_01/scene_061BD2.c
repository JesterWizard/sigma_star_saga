...
/* Script id 130 — map/NPC talk via event records (@ 0x080179C8 → StartTalkById). No cutscene FSM. Talk ROM 0x08061BD2. */
EVENT_SCRIPT_REPLACEMENT(0x08061BD2, scene_061BD2)
