...
/* Script id 77 — map/NPC talk via event records (@ 0x080179C8 → StartTalkById). No cutscene FSM. Talk ROM 0x0805E417. */
EVENT_SCRIPT_REPLACEMENT(0x0805E417, scene_05E417)
