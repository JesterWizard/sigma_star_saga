...
/* Script id 450 — map/NPC talk via event records (@ 0x080179C8 → StartTalkById). No cutscene FSM. Talk ROM 0x08076F1F. */
EVENT_SCRIPT_REPLACEMENT(0x08076F1F, scene_076F1F)
