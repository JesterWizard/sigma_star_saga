...
/* Script id 143 — map/NPC talk via event records (@ 0x080179C8 → StartTalkById). No cutscene FSM. Talk ROM 0x08062DD7. */
EVENT_SCRIPT_REPLACEMENT(0x08062DD7, scene_062DD7)
