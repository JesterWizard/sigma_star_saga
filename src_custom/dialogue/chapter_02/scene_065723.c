...
/* Script id 178 — map/NPC talk via event records (@ 0x080179C8 → StartTalkById). No cutscene FSM. Talk ROM 0x08065723. */
EVENT_SCRIPT_REPLACEMENT(0x08065723, scene_065723)
