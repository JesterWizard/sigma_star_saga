...
/* Script id 152 — map/NPC talk via event records (@ 0x080179C8 → StartTalkById). No cutscene FSM. Talk ROM 0x0806336D. */
EVENT_SCRIPT_REPLACEMENT(0x0806336D, scene_06336D)
