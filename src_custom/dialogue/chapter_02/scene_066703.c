...
/* Script id 191 — map/NPC talk via event records (@ 0x080179C8 → StartTalkById). No cutscene FSM. Talk ROM 0x08066703. */
EVENT_SCRIPT_REPLACEMENT(0x08066703, scene_066703)
