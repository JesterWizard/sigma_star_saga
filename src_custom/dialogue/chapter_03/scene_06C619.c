...
/* Script id 296 — map/NPC talk via event records (@ 0x080179C8 → StartTalkById). No cutscene FSM. Talk ROM 0x0806C619. */
EVENT_SCRIPT_REPLACEMENT(0x0806C619, scene_06C619)
