...
/* Script id 290 — map/NPC talk via event records (@ 0x080179C8 → StartTalkById). No cutscene FSM. Talk ROM 0x0806BB74. */
EVENT_SCRIPT_REPLACEMENT(0x0806BB74, scene_06BB74)
