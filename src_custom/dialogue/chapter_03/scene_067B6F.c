...
/* Script id 203 — map/NPC talk via event records (@ 0x080179C8 → StartTalkById). No cutscene FSM. Talk ROM 0x08067B6F. */
EVENT_SCRIPT_REPLACEMENT(0x08067B6F, scene_067B6F)
