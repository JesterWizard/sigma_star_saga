...
/* Script id 400 — map/NPC talk via event records (@ 0x080179C8 → StartTalkById). No cutscene FSM. Talk ROM 0x080736C6. */
EVENT_SCRIPT_REPLACEMENT(0x080736C6, scene_0736C6)
